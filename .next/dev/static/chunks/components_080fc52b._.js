...
function CursorGlow() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CursorGlow.useEffect": ()=>{
            const handleMove = {
                "CursorGlow.useEffect.handleMove": (event)=>{
                    setPosition({
                        x: event.clientX,
                        y: event.clientY
                    });
            ...
            return ({
                "CursorGlow.useEffect": ()=>window.removeEventListener("pointermove", handleMove)
            })["CursorGlow.useEffect"];
        }
    }["CursorGlow.useEffect"], []);
...
_s(CursorGlow, "jv34aNIyPo+g3wMR9igNqlVW3h8=");
_c = CursorGlow;
var _c;
...
//# sourceMappingURL=components_080fc52b._.js.map